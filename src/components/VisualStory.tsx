  ...
  const steps = [
    {
      ...
      content: "People made their first tools. Hammers and knives helped them build better lives.",
      highlightText: "Small changes can make big differences.",
    ...
    },
    {
      ...
      content: "Trains and cars were invented. People could travel far and fast for the first time.",
      highlightText: "We could go anywhere we wanted.",
    ...
    },
    {
      ...
      content: "Computers and the internet connected everyone. People could talk to friends anywhere in the world.",
      highlightText: "We could share ideas instantly.",
    ...
    },
    {
      ...
      content: "Smart computers can now help us think and create amazing things.",
      highlightText: "Smart tools help us every day.",
    ...
    },
    {
      ...
      content: "Amazing new inventions are coming that will change how we live.",
      highlightText: "Get ready for exciting new changes.",
